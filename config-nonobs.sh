...
# 2024
export STATIONS="Aa Ax BAJA CNI GAM Gl GLTS HAY JELM Kt LAS LLA Lm Mg Mm Nn OVRO Pv Sw Sz KVN-Pyeongchang KVN-Yonsei"

export START="0 days"
export END="14 days"
#export VEX="--vex 2023-schedules/*.vex"
export VEX=
export EMPHASIZE="Nn:Gl:Ax:Aa:Kt:Mg:Sw:Mm:Sz:Lm:Pv:KVN-Pyeongchang:KVN-Yonsei"
